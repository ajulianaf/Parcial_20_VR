...
public class CameraPointerManager : MonoBehaviour
{
    ...
    private readonly string interactableTag = "Interactable"; // tag de interaccion igual que adiomanager
    ...
    private void Start ()
    {
        GazeManager.Instance.OnGazeSelection += GazeSelection;//siglenton
    }
   ...
   public void Update()
   {
        RaycastHit hit;// camara sakga auna linea y que aga las interacioes 
        ...
        {//getSelecion
           hitPoint = hit.point;
            ...
            if (_gazedAtObject != hit.transform.gameObject)
            {
                ...
                //Fuacinonalideas ontigar o intriger enter 
            }
...

        {
            ...
            //que cuando choque llege nuestro objeto y se mueste 
        }
        ...
        private Vector3 CalculatePointerPosition(Vector3 p0, Vector3 p1, float t)
        {
            ...
            float y = p0.y + t * (p1.y - p0.y); // calcule el punto medio de una linea 
